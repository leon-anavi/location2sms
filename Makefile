...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ??? 10. ??? 23:38:01 2012
...
SOURCES       = main.cpp \
		...
		busyindicator.cpp \
		languageswidget.cpp \
		urlshortener.cpp moc/moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/location2sms1.0.0/ && $(COPY_FILE) --parents mainwindow.h aboutwidget.h menuwidget.h mainwidget.h reversegeocoding.h filedownloader.h busyindicator.h languageswidget.h urlshortener.h obj/location2sms1.0.0/ && $(COPY_FILE) --parents l2sResource.qrc obj/location2sms1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp aboutwidget.cpp menuwidget.cpp mainwidget.cpp reversegeocoding.cpp filedownloader.cpp busyindicator.cpp languageswidget.cpp urlshortener.cpp obj/location2sms1.0.0/ && $(COPY_FILE) --parents mainwindow.ui obj/location2sms1.0.0/ && $(COPY_FILE) --parents location2sms_bg.ts location2sms_tr.ts location2sms_de.ts location2sms_ro.ts obj/location2sms1.0.0/ && (cd `dirname obj/location2sms1.0.0` && $(TAR) location2sms1.0.0.tar location2sms1.0.0 && $(COMPRESS) location2sms1.0.0.tar) && $(MOVE) `dirname obj/location2sms1.0.0`/location2sms1.0.0.tar.gz . && $(DEL_FILE) -r obj/location2sms1.0.0
...
compiler_moc_header_make_all: moc/moc_mainwindow.cpp moc/moc_aboutwidget.cpp moc/moc_menuwidget.cpp moc/moc_mainwidget.cpp moc/moc_reversegeocoding.cpp moc/moc_filedownloader.cpp moc/moc_busyindicator.cpp moc/moc_languageswidget.cpp moc/moc_urlshortener.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_mainwindow.cpp moc/moc_aboutwidget.cpp moc/moc_menuwidget.cpp moc/moc_mainwidget.cpp moc/moc_reversegeocoding.cpp moc/moc_filedownloader.cpp moc/moc_busyindicator.cpp moc/moc_languageswidget.cpp moc/moc_urlshortener.cpp
...
ui/ui_mainwindow.h: mainwindow.ui
	c:/QtSDK/Madde/targets/harmattan_10.2011.34-1_rt1.2/bin/uic.exe mainwindow.ui -o ui/ui_mainwindow.h
...
install:  install_desktopfile install_icon install_target install_icon  FORCE

uninstall: uninstall_desktopfile uninstall_icon uninstall_target uninstall_icon   FORCE
