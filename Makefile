...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ?? 19. ??? 16:24:52 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/location2sms1.0.0/ && $(COPY_FILE) --parents mainwindow.h aboutwidget.h menuwidget.h mainwidget.h reversegeocoding.h filedownloader.h busyindicator.h languageswidget.h urlshortener.h settings.h obj/location2sms1.0.0/ && $(COPY_FILE) --parents l2sResource.qrc obj/location2sms1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp aboutwidget.cpp menuwidget.cpp mainwidget.cpp reversegeocoding.cpp filedownloader.cpp busyindicator.cpp languageswidget.cpp urlshortener.cpp settings.cpp obj/location2sms1.0.0/ && $(COPY_FILE) --parents mainwindow.ui obj/location2sms1.0.0/ && $(COPY_FILE) --parents location2sms_bg.ts location2sms_tr.ts location2sms_de.ts location2sms_ro.ts obj/location2sms1.0.0/ && (cd `dirname obj/location2sms1.0.0` && $(TAR) location2sms1.0.0.tar location2sms1.0.0 && $(COMPRESS) location2sms1.0.0.tar) && $(MOVE) `dirname obj/location2sms1.0.0`/location2sms1.0.0.tar.gz . && $(DEL_FILE) -r obj/location2sms1.0.0
