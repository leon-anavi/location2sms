...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ??? 29. ??? 12:48:11 2012
# Project:  location2sms.pro
# Template: app
# Command: c:/qtsdk/madde/targets/harmattan_10.2011.34-1/bin/qmake.exe -spec ../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/default -unix -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o Makefile location2sms.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_NO_DEBUG -DQT_DECLARATIVE_LIB -DQT_WEBKIT_LIB -DQT_XML_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -O2 -g -Wno-psabi -Wall -W -D_REENTRANT $(DEFINES)
CXXFLAGS      = -pipe -O2 -g -Wno-psabi -Wall -W -D_REENTRANT $(DEFINES)
INCPATH       = -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/default -I. -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtCore -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtNetwork -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtGui -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtXml -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtWebKit -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtDeclarative -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4 -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtMessaging -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtLocation -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4 -I../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtMobility -Imoc -Iui
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,C:/usr/lib
LIBS          = $(SUBLIBS)  -LC:/QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/lib -L/usr/lib -lQtLocation -lQtMessaging -lQtDeclarative -lQtWebKit -lQtXml -lQtGui -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		filedownloader.cpp \
		busyindicator.cpp \
		languageswidget.cpp moc/moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/location2sms1.0.0/ && $(COPY_FILE) --parents mainwindow.h aboutwidget.h menuwidget.h mainwidget.h reversegeocoding.h filedownloader.h busyindicator.h languageswidget.h obj/location2sms1.0.0/ && $(COPY_FILE) --parents l2sResource.qrc obj/location2sms1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp aboutwidget.cpp menuwidget.cpp mainwidget.cpp reversegeocoding.cpp filedownloader.cpp busyindicator.cpp languageswidget.cpp obj/location2sms1.0.0/ && $(COPY_FILE) --parents mainwindow.ui obj/location2sms1.0.0/ && $(COPY_FILE) --parents location2sms_bg.ts location2sms_tr.ts location2sms_de.ts location2sms_ro.ts obj/location2sms1.0.0/ && (cd `dirname obj/location2sms1.0.0` && $(TAR) location2sms1.0.0.tar location2sms1.0.0 && $(COMPRESS) location2sms1.0.0.tar) && $(MOVE) `dirname obj/location2sms1.0.0`/location2sms1.0.0.tar.gz . && $(DEL_FILE) -r obj/location2sms1.0.0
...
compiler_moc_header_make_all: moc/moc_mainwindow.cpp moc/moc_aboutwidget.cpp moc/moc_menuwidget.cpp moc/moc_mainwidget.cpp moc/moc_reversegeocoding.cpp moc/moc_filedownloader.cpp moc/moc_busyindicator.cpp moc/moc_languageswidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_mainwindow.cpp moc/moc_aboutwidget.cpp moc/moc_menuwidget.cpp moc/moc_mainwidget.cpp moc/moc_reversegeocoding.cpp moc/moc_filedownloader.cpp moc/moc_busyindicator.cpp moc/moc_languageswidget.cpp
...
moc/moc_aboutwidget.cpp: aboutwidget.h
	C:/QtSDK/Madde/targets/harmattan_10.2011.34-1/bin/moc.exe $(DEFINES) $(INCPATH) aboutwidget.h -o moc/moc_aboutwidget.cpp

moc/moc_menuwidget.cpp: menuwidget.h
	C:/QtSDK/Madde/targets/harmattan_10.2011.34-1/bin/moc.exe $(DEFINES) $(INCPATH) menuwidget.h -o moc/moc_menuwidget.cpp
...
moc/moc_mainwidget.cpp: aboutwidget.h \
		...
		languageswidget.h \
		mainwidget.h
	C:/QtSDK/Madde/targets/harmattan_10.2011.34-1/bin/moc.exe $(DEFINES) $(INCPATH) mainwidget.h -o moc/moc_mainwidget.cpp

moc/moc_reversegeocoding.cpp: filedownloader.h \
		reversegeocoding.h
	C:/QtSDK/Madde/targets/harmattan_10.2011.34-1/bin/moc.exe $(DEFINES) $(INCPATH) reversegeocoding.h -o moc/moc_reversegeocoding.cpp

moc/moc_filedownloader.cpp: filedownloader.h
	C:/QtSDK/Madde/targets/harmattan_10.2011.34-1/bin/moc.exe $(DEFINES) $(INCPATH) filedownloader.h -o moc/moc_filedownloader.cpp

moc/moc_busyindicator.cpp: busyindicator.h
	C:/QtSDK/Madde/targets/harmattan_10.2011.34-1/bin/moc.exe $(DEFINES) $(INCPATH) busyindicator.h -o moc/moc_busyindicator.cpp

moc/moc_languageswidget.cpp: languageswidget.h
	C:/QtSDK/Madde/targets/harmattan_10.2011.34-1/bin/moc.exe $(DEFINES) $(INCPATH) languageswidget.h -o moc/moc_languageswidget.cpp
...
rcc/qrc_l2sResource.cpp: l2sResource.qrc \
		...
		location2sms_bg.qm \
		location2sms_ro.qm
	c:/QtSDK/Madde/targets/harmattan_10.2011.34-1/bin/rcc.exe -name l2sResource l2sResource.qrc -o rcc/qrc_l2sResource.cpp
...
install_icon: first FORCE
	...
	-$(INSTALL_FILE) c:/gitorious/location2sms/location2sms.png $(INSTALL_ROOT)/usr/share/icons/hicolor/64x64/apps/


uninstall_icon:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/64x64/apps/location2sms.png
