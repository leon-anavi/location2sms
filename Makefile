...
# Generated by qmake (2.01a) (Qt 4.7.3) on: Mon Aug 8 01:35:36 2011
...
location2sms_template.pkg: C:/Symbian/QtCreator/location2sms/location2sms.pro
	$(MAKE) -f $(MAKEFILE) qmake

location2sms_installer.pkg: C:/Symbian/QtCreator/location2sms/location2sms.pro
	$(MAKE) -f $(MAKEFILE) qmake

location2sms_stub.pkg: C:/Symbian/QtCreator/location2sms/location2sms.pro
	$(MAKE) -f $(MAKEFILE) qmake
...
compiler_moc_header_make_all: moc\moc_mainwindow.cpp moc\moc_aboutwidget.cpp moc\moc_menuwidget.cpp moc\moc_mainwidget.cpp moc\moc_reversegeocoding.cpp moc\moc_filedownloader.cpp moc\moc_busyindicator.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc\moc_mainwindow.cpp moc\moc_aboutwidget.cpp moc\moc_menuwidget.cpp moc\moc_mainwidget.cpp moc\moc_reversegeocoding.cpp moc\moc_filedownloader.cpp moc\moc_busyindicator.cpp
...
create_temps:
	...
	-@ if not exist "C:\Symbian\QtCreator\location2sms\moc\tmp" mkdir "C:\Symbian\QtCreator\location2sms\moc\tmp"
	-@ if not exist "C:\Symbian\QtCreator\location2sms\ui\tmp" mkdir "C:\Symbian\QtCreator\location2sms\ui\tmp"
	-@ if not exist "C:\Symbian\QtCreator\location2sms\tmp" mkdir "C:\Symbian\QtCreator\location2sms\tmp"
...
extension_clean: compiler_clean
	...
	-@ if EXIST "C:\Symbian\QtCreator\location2sms\moc\tmp" rmdir /s /q  "C:\Symbian\QtCreator\location2sms\moc\tmp"
	-@ if EXIST "C:\Symbian\QtCreator\location2sms\ui\tmp" rmdir /s /q  "C:\Symbian\QtCreator\location2sms\ui\tmp"
	-@ if EXIST "C:\Symbian\QtCreator\location2sms\tmp" rmdir /s /q  "C:\Symbian\QtCreator\location2sms\tmp"
...
dodistclean:
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\location2sms_template.pkg" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\location2sms_template.pkg"
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\location2sms_stub.pkg" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\location2sms_stub.pkg"
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\location2sms_installer.pkg" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\location2sms_installer.pkg"
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\Makefile" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\Makefile"
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\Makefile_location2sms_exe.mk" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\Makefile_location2sms_exe.mk"
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\location2sms_exe.mmp" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\location2sms_exe.mmp"
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\location2sms_reg.rss" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\location2sms_reg.rss"
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\location2sms.rss" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\location2sms.rss"
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\location2sms.loc" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\location2sms.loc"
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\bld.inf" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\bld.inf"
	-@ if EXIST "c:\Symbian\QtCreator\location2sms\${ZDIR}\resource\apps\location2sms.mif" $(DEL_FILE)  "c:\Symbian\QtCreator\location2sms\${ZDIR}\resource\apps\location2sms.mif"
