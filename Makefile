...
# Generated by qmake (2.01a) (Qt 4.7.3) on: ?? 11. ??? 11:25:05 2012
...
moc\moc_proxywidget.cpp: mainwindow.h \
		...
		urlshortener.h \
		proxywidget.h
	C:\QtSDK\Symbian\SDKs\Symbian1Qt473\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN proxywidget.h -o moc\moc_proxywidget.cpp
...
create_temps:
	...
	-@ if not exist "C:\gitorious\location2sms\qmlapplicationviewer\tmp" mkdir "C:\gitorious\location2sms\qmlapplicationviewer\tmp"
...
extension_clean: compiler_clean
	...
	-@ if EXIST "C:\gitorious\location2sms\qmlapplicationviewer\tmp" rmdir /s /q  "C:\gitorious\location2sms\qmlapplicationviewer\tmp"
...
winscw_deployment:
	...
	-$(XCOPY) "c:\gitorious\location2sms\qml\TestView\main.qml" "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\winscw\c\private\e864cbe1\qml\TestView\"
	-$(XCOPY) "c:\gitorious\location2sms\qml\TestView\MainPage.qml" "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\winscw\c\private\e864cbe1\qml\TestView\"

winscw_deployment_clean:
	-@ if EXIST "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\winscw\c\private\e864cbe1\qml\TestView\main.qml" $(DEL_FILE)  "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\winscw\c\private\e864cbe1\qml\TestView\main.qml"
	-@ if EXIST "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\winscw\c\private\e864cbe1\qml\TestView\MainPage.qml" $(DEL_FILE)  "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\winscw\c\private\e864cbe1\qml\TestView\MainPage.qml"

deployment:
	-echo Deploying changed files...
	-$(XCOPY) "c:\gitorious\location2sms\qml\TestView\main.qml" "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\data\z\private\e864cbe1\qml\TestView\"
	-$(XCOPY) "c:\gitorious\location2sms\qml\TestView\MainPage.qml" "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\data\z\private\e864cbe1\qml\TestView\"

deployment_clean:
	-@ if EXIST "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\data\z\private\e864cbe1\qml\TestView\main.qml" $(DEL_FILE)  "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\data\z\private\e864cbe1\qml\TestView\main.qml"
	-@ if EXIST "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\data\z\private\e864cbe1\qml\TestView\MainPage.qml" $(DEL_FILE)  "\QtSDK\Symbian\SDKs\Symbian1Qt473\epoc32\data\z\private\e864cbe1\qml\TestView\MainPage.qml"
