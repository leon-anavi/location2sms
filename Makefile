...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ?? 11. ??? 20:57:14 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/location2sms1.0.0/ && $(COPY_FILE) --parents qmlapplicationviewer/qmlapplicationviewer.h proxywidget.h urlshortener.h settings.h reversegeocoding.h proxywidget.h menuwidget.h mainwindow.h mainwidget.h languageswidget.h filedownloader.h busyindicator.h aboutwidget.h custommessagebox.h obj/location2sms1.0.0/ && $(COPY_FILE) --parents l2sResource.qrc obj/location2sms1.0.0/ && $(COPY_FILE) --parents main.cpp proxywidget.cpp urlshortener.cpp settings.cpp reversegeocoding.cpp menuwidget.cpp mainwindow.cpp mainwidget.cpp languageswidget.cpp filedownloader.cpp busyindicator.cpp aboutwidget.cpp custommessagebox.cpp qmlapplicationviewer/qmlapplicationviewer.cpp obj/location2sms1.0.0/ && $(COPY_FILE) --parents location2sms_bg.ts location2sms_tr.ts location2sms_de.ts location2sms_ro.ts location2sms_el.ts location2sms_nl.ts location2sms_cs.ts location2sms_id.ts obj/location2sms1.0.0/ && (cd `dirname obj/location2sms1.0.0` && $(TAR) location2sms1.0.0.tar location2sms1.0.0 && $(COMPRESS) location2sms1.0.0.tar) && $(MOVE) `dirname obj/location2sms1.0.0`/location2sms1.0.0.tar.gz . && $(DEL_FILE) -r obj/location2sms1.0.0
...
moc/moc_custommessagebox.cpp: custommessagebox.h
	C:/QtSDK/Madde/targets/harmattan_10.2011.34-1_rt1.2/bin/moc.exe $(DEFINES) $(INCPATH) custommessagebox.h -o moc/moc_custommessagebox.cpp
...
obj/custommessagebox.o: custommessagebox.cpp custommessagebox.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/custommessagebox.o custommessagebox.cpp
...
obj/moc_custommessagebox.o: moc/moc_custommessagebox.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/moc_custommessagebox.o moc/moc_custommessagebox.cpp
