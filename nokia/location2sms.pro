...
symbian:
{
    ...
    packageheader = "$${LITERAL_HASH}{\"location2sms\"}, ($${TARGET.UID3}), 2, 1, 8"
...
TRANSLATIONS = location2sms_bg.ts location2sms_tr.ts location2sms_de.ts location2sms_ro.ts location2sms_el.ts location2sms_nl.ts location2sms_cs.ts location2sms_ru.ts location2sms_id.ts location2sms_fi.ts
